...
-- Date        : Mon Feb  5 00:29:26 2018
-- Host        : Anthony running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               C:/Users/Anthony/Documents/ECE532/servo/servo.srcs/sources_1/bd/design_1/ip/design_1_servo_ip_0_1/design_1_servo_ip_0_1_sim_netlist.vhdl
...
entity design_1_servo_ip_0_1_srervo_ip_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_servo_ip_0_1_srervo_ip_v1_0_S00_AXI : entity is "srervo_ip_v1_0_S00_AXI";
end design_1_servo_ip_0_1_srervo_ip_v1_0_S00_AXI;

architecture STRUCTURE of design_1_servo_ip_0_1_srervo_ip_v1_0_S00_AXI is
...
\SERVO_PWM1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \SERVO_PWM1_carry__0_i_1_n_0\,
      S(2) => \SERVO_PWM1_carry__0_i_2_n_0\,
      S(1) => \SERVO_PWM1_carry__0_i_3_n_0\,
      S(0) => \SERVO_PWM1_carry__0_i_4_n_0\
    );
\SERVO_PWM1_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM1_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM1_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM1_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \SERVO_PWM1_carry__1_i_1_n_0\,
      S(2) => \SERVO_PWM1_carry__1_i_2_n_0\,
      S(1) => \SERVO_PWM1_carry__1_i_3_n_0\,
      S(0) => \SERVO_PWM1_carry__1_i_4_n_0\
    );
\SERVO_PWM1_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM1_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM1_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
SERVO_PWM1_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
SERVO_PWM1_carry_i_4: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
SERVO_PWM1_carry_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
SERVO_PWM1_carry_i_8: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\SERVO_PWM2_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \SERVO_PWM2_carry__0_i_1_n_0\,
      S(2) => \SERVO_PWM2_carry__0_i_2_n_0\,
      S(1) => \SERVO_PWM2_carry__0_i_3_n_0\,
      S(0) => \SERVO_PWM2_carry__0_i_4_n_0\
    );
...
\SERVO_PWM2_carry__0_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM2_carry__1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \SERVO_PWM2_carry__1_i_1_n_0\,
      S(2) => \SERVO_PWM2_carry__1_i_2_n_0\,
      S(1) => \SERVO_PWM2_carry__1_i_3_n_0\,
      S(0) => \SERVO_PWM2_carry__1_i_4_n_0\
    );
\SERVO_PWM2_carry__1_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM2_carry__1_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\SERVO_PWM2_carry__1_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
SERVO_PWM2_carry_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
SERVO_PWM2_carry_i_4: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\counterPeriod11_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counterPeriod11_carry__0_i_2_n_0\,
      S(2) => \counterPeriod11_carry__0_i_3_n_0\,
      S(1) => \counterPeriod11_carry__0_i_4_n_0\,
      S(0) => \counterPeriod11_carry__0_i_5_n_0\
    );
\counterPeriod11_carry__0_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\counterPeriod21_carry__0\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3) => \counterPeriod21_carry__0_i_2_n_0\,
      S(2) => \counterPeriod21_carry__0_i_3_n_0\,
      S(1) => \counterPeriod21_carry__0_i_4_n_0\,
      S(0) => \counterPeriod21_carry__0_i_5_n_0\
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_servo_ip_0_1_srervo_ip_v1_0 is
  port (
    S_AXI_ARREADY : out STD_LOGIC;
    s00_axi_rdata : out STD_LOGIC_VECTOR ( 31 downto 0 );
    S_AXI_AWREADY : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_servo_ip_0_1_srervo_ip_v1_0 : entity is "srervo_ip_v1_0";
end design_1_servo_ip_0_1_srervo_ip_v1_0;

architecture STRUCTURE of design_1_servo_ip_0_1_srervo_ip_v1_0 is
begin
srervo_ip_v1_0_S00_AXI_inst: entity work.design_1_servo_ip_0_1_srervo_ip_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_servo_ip_0_1 is
  port (
    servoPWM1 : out STD_LOGIC;
    servoPWM2 : out STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_servo_ip_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_servo_ip_0_1 : entity is "design_1_servo_ip_0_1,srervo_ip_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_servo_ip_0_1 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_servo_ip_0_1 : entity is "srervo_ip_v1_0,Vivado 2017.2";
end design_1_servo_ip_0_1;

architecture STRUCTURE of design_1_servo_ip_0_1 is
...
inst: entity work.design_1_servo_ip_0_1_srervo_ip_v1_0
     port map (
